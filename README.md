...
do
    ...
    echo "slim -d SEED=$i -d sigma=$sigma -d K=4 -d mu=0 -d r=1e-8 -d W=50 -d G=1e8 -d maxgens=1000000 -d OUTNAME=\"'Temp_wd/TreeSeqs/output'\" SLiM_recipes/map12.slim" >> simlist.txt
done
```
